# Unit test data containing a material model with a circular assembly reference.
# In this case, Seating_Area reference sub-assembly Seating which in turn references sub-site Seating_Area.
...
assembly:
  name: Seating
  descriptiosn: The things you can sit on.
  sub-assemblies:
    - assembly-ref: Seating_Area
      quantity: 1
  parts:
