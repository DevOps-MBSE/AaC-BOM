# Unit test data containing a material model with a bad assembly reference.
# In this case, Entertainment_System_BROKEN assembly reference in Living_Room does not exist.
# This should result in a validation failure within the validate_referenced_materials validator.
# There should be no other errors in this material model.

BAD_ASSEMBLY_MATERIAL_REFERENCE = """
site:
...
site:
  ...
  assemblies:
    - assembly-ref: Entertainment_System_BROKEN
      quantity: 1
