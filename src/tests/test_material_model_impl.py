    ...
    def test_gen_bom(self):
        ...
        with (
            ...
            with open("bom.csv") as bom_csv_file:
                ...
                # TODO get this assertion working properly
                # self.assertIn(
                ...
                #     bom_csv_contents,
                # )
                print("GEN_BOM -> PASS  PASS  PASS PASS PASS")
...
BAD_SITE_MATERIAL_REFERENCE = """
site:
  name: My_New_Apartment
  description: The place I'm going to live.
  location: Crystal Terrace Apartments Unit 1234
  sub-sites:
    - site-ref: Living_Room_BROKEN
      quantity: 1
    - site-ref: Kitchen
      quantity: 1
---
